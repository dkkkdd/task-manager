  ...
  return NAV_ITEMS.map((nav) => {
    return (
      <Link
        ...
        to={`/${nav.id}`}
        className={`${mode === nav.id ? "bg-[#9d174d]/15 text-[#9d174d] dark:text-white" : "text-gray-700 dark:text-white/70"} flex items-center gap-3 p-2 cursor-pointer hover:bg-black/5 dark:hover:bg-[#363636] w-full rounded-lg m-0`}
      >
